...
@onready var lbl_hero: Label = /HUD/CommandPanel/Panel/Margin/VBox/HeaderRow/HeroInfo/HeroText/HeroLabel
@onready var hero_status_container: HBoxContainer = /HUD/CommandPanel/Panel/Margin/VBox/HeaderRow/HeroInfo/HeroText/HeroStatus
@onready var hero_hp_bar: ProgressBar = /HUD/CommandPanel/Panel/Margin/VBox/HeaderRow/HeroInfo/HeroText/HeroHPBar
@onready var hero_mp_bar: ProgressBar = /HUD/CommandPanel/Panel/Margin/VBox/HeaderRow/HeroInfo/HeroText/HeroMPBar
@onready var lbl_enemy: Label = /HUD/EnemyPanel/Margin/EnemyRow/EnemyInfo/EnemyLabel
@onready var enemy_status_container: HBoxContainer = /HUD/EnemyPanel/Margin/EnemyRow/EnemyInfo/EnemyStatus
@onready var enemy_hp_bar: ProgressBar = /HUD/EnemyPanel/Margin/EnemyRow/EnemyInfo/EnemyHPBar
@onready var hero_portrait_rect: TextureRect = /HUD/CommandPanel/Panel/Margin/VBox/HeaderRow/HeroInfo/HeroPortraitFrame/HeroPortrait
@onready var enemy_portrait_rect: TextureRect = /HUD/EnemyPanel/Margin/EnemyRow/EnemyInfo/EnemyPortrait
@onready var plan_label: Label = /HUD/CommandPanel/Panel/Margin/VBox/PlanBubble/PlanMargin/PlanVBox/PlanLabel
@onready var btn_attack: Button = /HUD/CommandPanel/Panel/Margin/VBox/Buttons/Attack
@onready var btn_fire: Button = /HUD/CommandPanel/Panel/Margin/VBox/Buttons/Fireball
@onready var btn_potion: Button = /HUD/CommandPanel/Panel/Margin/VBox/Buttons/Potion
@onready var btn_end: Button = /HUD/CommandPanel/Panel/Margin/VBox/Buttons/EndTurn
@onready var buttons_row: HBoxContainer = /HUD/CommandPanel/Panel/Margin/VBox/Buttons
@onready var lbl_queue: Label = /HUD/CommandPanel/Panel/Margin/VBox/PlanBubble/PlanMargin/PlanVBox/TurnOrderLabel
@onready var log_view: RichTextLabel = /HUD/CommandPanel/Panel/Margin/VBox/Log
@onready var hero_sprite_placeholder: Sprite2D = /HeroSprite
@onready var enemy_sprite_placeholder: Sprite2D = /EnemySprite
@onready var hero_shadow: Sprite2D = /HeroShadow
@onready var enemy_shadow: Sprite2D = /EnemyShadow
@onready var fx_controller: Node = 
@onready var popups_container: Control = /Popups
@onready var overlay_fade: ColorRect = /Fade
@onready var overlay_title: Label = /CenterContainer/VBoxContainer/Label
@onready var overlay_subtitle: Label = /CenterContainer/VBoxContainer/Label2
